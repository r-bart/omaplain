...
var EN = {
  ...
  "apps.body": "Everything happens on this machine. OmaPlain does not store the copied text. The history belongs to Omarchy.",
  ...
  "apps.open.none": "No window to recognise right now. Type the class instead.",
...
var ES = {
  ...
  "apps.body": "Todo ocurre en este equipo. OmaPlain no guarda el texto copiado. El historial pertenece a Omarchy.",
  ...
  "apps.open.none": "Ahora mismo no hay ninguna ventana que reconocer. Escribe la clase.",
